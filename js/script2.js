...
const itemIcons = {
    ...
    'piedra': {
        ...
        name: 'Piedra Grabada',
        description: 'Una piedra con símbolos tallados a mano.'
    },
    'diagrama_espiral': {
...
//Capitulo 2
    ...
    'barra_palanca': {
        icon: 'assets/icons/barra_palanca.png',
...
monogatari.assets ('scenes', {
	...
	'bg_minijuego_jardin': 'jardin_puzzle.png',
	...
	'artefacto_luz_glow': 'artefacto_luz_glow.png',
...
monogatari.characters ({
    ...
    'isidora': {
        ...
        sprites: {
			...
			determined: 'isidora_surprised.png',
        }
    },
...
// -------------------------------------------------------------------------
	...
	'Escena1_Abrir': [
        ...
        () => stopIconFollow(),
        () => {
            const hotspot = document.getElementById('vitrina');
            hotspot.style.display = 'block';
            hotspot.style.pointerEvents = 'auto';
			//hotspot.title = 'Vitrina de exhibición de seguridad. Necesitas un objeto para abrirla.';
            //hotspot.style.zIndex = '999999';
            ...
            hotspot.onclick = () => {
                ...
                //if (tieneLlave) {
                if (selectedItem === 'llave_antigua') {
					monogatari.run('narrator La vitrina se abre.');
                    monogatari.run('jump Escena1_Tomar');
                } else {
                    monogatari.run('narrator El vitrina continua cerrada. Debes utilizar un objeto.');
                }
            };
        },
	...
	'Escena1_Tomar': [
        ...
        () => {
            ...
            hotspot.onclick = () => {
                ...
                //flyItemTo(selectedItem, hotspot);
                //if (tieneLlave) {
                if (selectedItem === 'panuelo') {
					monogatari.run('narrator Toma la piedra de Ngenechén.');
                    addItem('piedra_ngenechen');
                    monogatari.run('jump Escena1_Decidir');
                } else {
                    monogatari.run('narrator La piedra continua en su lugar. Debes utilizar un objeto.');
                }
            };
        },
...
'show character tomas normal at right with fadeIn',
	...
	'Escena2_Confesar': [
		...
		'show storage Tomas_Confianza true',
	...
	'Escena2_Ignorar': [
		...
		'Tomás se frustra y se pierde una pista clave sobre Alejandría.',
		'jump Escena3_Laboratorio'
	],
	...
	'Escena4_LabEscaneo': [
		...
		'show character gabriel normal at left with fadeIn',
		'show character lucia concentrada at right with fadeIn',

		'Los monitores del supercomputador muestran la nube de puntos tridimensional de la piedra.',
		'El láser azul recorre los surcos, digitalizando cada micra de la superficie volcánica.',
	...
	'Escena11_DecisionEstrategica': [
...

		{
			'Choice': {
				...
				'Ruta_Grecia': {
					'Text': 'Viajar a Grecia y Turquía (Atenas y Halicarnaso - Antípatro y el Mausoleo)',
...
'Escena13': [
...

		{
			'Choice': {
				...
				'Opcion_Poema': {
					'Text': 'Preguntar directamente por el contenido y origen del poema olvidado',
					'Do': 'jump Escena14'
				},
				'Opcion_Mausoleo': {
	...
	'Escena14': [
		...
		'[MINIJEUEGO PUZZLE - RECONSTRUCCIÓN DEL EPIGRAMA]',
		'Ordenar versos fragmentados | Rotar piezas de pergamino digital | Identificar palabras clave en griego antiguo.',

		// Interacción con Objeto: Lupa de Filólogo & Pergamino Digital
		{
			'Choice': {
				'Dialog': '[INTERACCIÓN DE OBJETOS: Módulo de Traducción y Lupa Digital]',
				'Opcion_Lupa': {
					'Text': '🔍 Usar la Lupa de Filólogo para inspeccionar las esquinas quemadas del pergamino',
					'Do': 'La lupa revela pigmentos de tinta de agalla de roble usados exclusivamente en Alejandría durante el siglo III a.C.'
				},
				'Opcion_Escaner': {
					'Text': '📜 Escanear el texto griego con la tablet para cotejo automático',
					'Do': 'El escáner resalta tres palabras clave: "Arktos" (Norte), "Notos" (Sur) y "Phos" (Luz).'
				}
			}
		},

		'Resultado del puzzle: “Las siete maravillas son testigos del ingenio humano, pero la octava luz guía a las siete desde el sur del mundo.”',
...

		{
			'Choice': {
				...
				'Opcion_Traduccion': {
					'Text': 'Analizar en profundidad las variaciones dialectales del epigrama',
					'Do': 'jump Escena15'
				},
				'Opcion_RutaGrecia': {
					'Text': 'Trazar el mapa de asentamientos helenísticos vinculados a la octava luz',
					'Do': 'jump Escena15'
				}
			}
		}
	...
	'Escena18': [
...

		{
			'Choice': {
				'Dialog': 'gabriel (Decisión del jugador)',
				'Opcion_Refugio': {
					'Text': 'Correr hacia la entrada del pasaje subterráneo protegido',
					'Do': 'jump Escena19'
				},
	...
	'Escena19': [
...

		{
			'Choice': {
				'Dialog': 'gabriel (Decisión del jugador)',
				'Opcion_Halicarnaso': {
					'Text': 'Poner rumbo directo al Mausoleo de Halicarnaso',
					'Do': 'jump Escena20'
				},
				...
				'Opcion_RutaSismica': {
					'Text': 'Evaluar si el temblor abrió otros pasajes en las ruinas',
					'Do': 'jump Escena20'
				}
			}
		}
	...
	'Escena24': [
		...
		'omar Bienvenidos. Tengo algo que deben ver.',
...
// -------------------------------------------------------------
	...
	'Escena31_PuzzleJardin': [
		'show scene bg_minijuego_jardin with fadeIn',
...
'Escena42_Intuicion': [
    'lucia A veces la intuición es más poderosa que la lógica.',
...
'Escena43': [
    ...
    'show character lucia normal at right',
    'lucia No. Es anterior a los mapuches. Anterior a los griegos. Anterior a todo lo que conocemos.',
...
'Escena44_Cuestionar': [
    'lucia ¿Y si esta narrativa fue manipulada por siglos?',
    'jump Escena45'
],
...
'Escena45_Salvar': [
    'narrator Ves a Lucía atrapada bajo una roca que bloquea su camino.',
    'narrator Sin dudarlo, corres hacia ella.',
    'show character lucia scared at center',
    'lucia ¡No puedo moverme!',
    'narrator Levantas la roca con esfuerzo y la liberas.',
    () => addItem('relacion_lucia_mejorada'),
...
'Escena47': [
    ...
    'show scene camara_subterranea with fadeIn duration 3s',
    ...
    'show character lucia normal at center',
    'lucia Y estuvo aquí todo el tiempo.',
...
'Escena48': [
    ...
    'show image artefacto_luz_glow at center with fadeIn',
    ...
    'show character lucia thinking at center',
    'lucia Si hay otra estructura... entonces la octava luz no era el final.',
    'lucia Era solo el comienzo.',
...
'Escena48_Dudar': [
    ...
    'lucia No. La precisión geométrica es perfecta. Esto no es un error.',
    'jump Escena49'
],
...
'Escena49': [
    ...
    'show character tomas nervous at left',
    'tomas La Antártida no es un destino cualquiera. Necesitaremos preparación, permisos, equipo especializado...',

    'show character lucia calm at center',
    'lucia Y discreción. Si revelamos esto demasiado pronto, podríamos perder el control de la información.',
...
'Escena49_Investigar': [
    'lucia Antes de viajar, debemos entender qué estamos buscando.',
...
'Escena50': [
    ...
    'show scene bg_patagonia_atardecer with fadeIn duration 4s',
    'narrator El sol comienza a ocultarse detrás de las montañas patagónicas.',
    ...
    'show character lucia smile at center',
    'lucia Ya lo sabemos.',
    'lucia "El Legado de la Luz".',
