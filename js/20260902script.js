...
// -------------------------------------------------------------------------
	...
	'Escena4_Decision': [
			...
			'Choice': {
				...
				//crear condicion para que cumpla todos los requisitos antes de presentar esta opción
				'Opcion_Patagonia': {
					...
					'Condition': () => hasItem('contacto_tomas') && hasItem('fichas_cartograficas')
				},
				'Opcion_Museo': {
					'Text': 'Volver donde Isidora, necesitamos datos del lugar donde se encontró la piedra',
					'Do': 'jump Escena1_Decidir',
					'Condition': () => !hasItem('fichas_cartograficas')
				},
				'Opcion_Clases': {
					'Text': 'Volver con Tomas, necesitamos su apoyo para el viaje',
					'Do': 'jump Escena2_AulaMagna',
					'Condition': () => !hasItem('contacto_tomas')
				}
			}
		}
	],
